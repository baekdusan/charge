...
enum ProviderMarks {
    /// 패스 데이터 24×24 좌표계 — claude·openai는 simple-icons(CC0),
    /// antigravity는 lobe-icons(MIT). 상표권은 각 사에 귀속.
    ...
    private static let antigravityD = "M21.751 22.607c1.34 1.005 3.35.335 1.508-1.508C17.73 15.74 18.904 1 12.037 1 5.17 1 6.342 15.74.815 21.1c-2.01 2.009.167 2.511 1.507 1.506 5.192-3.517 4.857-9.714 9.715-9.714 4.857 0 4.522 6.197 9.714 9.715z"

    private static let cache: [String: Path] = [
        "claude": SVGPathParser.parse(claudeD),
        "openai": SVGPathParser.parse(openaiD),
        "antigravity": SVGPathParser.parse(antigravityD),
    ]
    ...
    static func mark(for providerId: String) -> Path? {
        ...
        case "antigravity": return cache["antigravity"]
        default: return nil
        }
    }
}
